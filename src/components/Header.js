        ...
        <div className="container">
            ...
            <div id="navbar">
                <ul className="nav navbar-nav">
                    ...
                    <li className={(this.state.currentPage === 'projects') ? 'active': ''}><Link onClick={() => this.handleChange('projects', 'Projects', 'Practice Makes Perfect')} to='/projects'>Projects</Link></li>
